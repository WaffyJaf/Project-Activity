          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2 mt-4">
                  ...
                  <input
                    ...
                    className="w-full border-2 border-slate-200 rounded-xl p-4 text-slate-700 focus:outline-none focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all duration-200 bg-white/70"
                ...
                <div className="md:col-span-2">
                  <label className="block text-slate-700 font-semibold mb-3 text-xm uppercase tracking-wide">
                    วัตถุประสงค์และรายละเอียด <span className="text-red-500 ml-1">*</span>
                  </label>
                  <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div >
                  ...
                  <input
                    ...
                    className="w-full border-2 border-slate-200 rounded-xl p-4 text-slate-700 focus:outline-none focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all duration-200 bg-white/70"
                ...
                <div >
                  <label className="block text-slate-700 font-semibold mb-3 text-xm uppercase tracking-wide">
                    สถานที่ดำเนินการ <span className="text-red-500 ml-1">*</span>
                  </label>
                  <input
            ...
            <div className=" pl-6 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label className="block text-slate-700 font-semibold mb-3 text-xm uppercase tracking-wide">
                    งบประมาณ (บาท) <span className="text-red-500 ml-1">*</span>
                  </label>
                 ...
                 <div>
                  <label className="block text-slate-700 font-semibold mb-3 text-xm uppercase tracking-wide">
                    วันและเวลาดำเนินการ <span className="text-red-500 ml-1">*</span>
                  </label>
                  <input
                    type="datetime-local"
            ...
            <div className="pt-8 border-t border-slate-200">
              <div className="flex flex-col sm:flex-row gap-4 justify-end mr-80">
                ...
                <button
                  type="submit"
                  className="px-12 py-4 bg-gradient-to-r bg-green-700 text-white font-semibold rounded   focus:outline-none focus:ring-4 focus:ring-purple-200 transition-all duration-200 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 min-w-[200px]"
                >
